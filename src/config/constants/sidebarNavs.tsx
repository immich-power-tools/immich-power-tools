import { Copy, FileWarning, GalleryHorizontal, GalleryVerticalEnd, Image as ImageIcon, MapPin, MapPinX, PackageSearch, Rewind, Search, Settings, Share2, User, Video, Workflow } from "lucide-react";
...
export const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Missing Originals", link: "/assets/missing-originals", icon: <FileWarning className="h-4 w-4" /> },
    ],
  },
  {
    label: "Automation",
